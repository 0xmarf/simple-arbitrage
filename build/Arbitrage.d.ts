...
export declare function getBestCrossedMarket(crossedMarkets: Array<Array<EthMarket>>, tokenAddress: string): CrossedMarketDetails | undefined;
export declare function findArbitrageTrades(marketsByToken: MarketsByToken): Array<CrossedMarketDetails>;
