...
exports.Arbitrage = exports.findArbitrageTrades = exports.getBestCrossedMarket = void 0;
...
function findArbitrageTrades(marketsByToken) {
...
class Arbitrage {
    ...
    async evaluateMarkets(marketsByToken) {
        return findArbitrageTrades(marketsByToken);
    }
    async takeCrossedMarkets(bestCrossedMarkets, blockNumber, minerRewardPercentage) {
        for (const bestCrossedMarket of bestCrossedMarkets) {
            ...
            try {
                const estimateGas = await this.bundleExecutorContract.provider.estimateGas(transaction, {
            ...
            transaction.gasLimit = ethers_1.BigNumber.from(1000000);
