...
class UniswappyV2EthPair extends EthMarket_1.EthMarket {
    ...
    static getUniswappyMarkets(provider, factoryAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < BATCH_COUNT_LIMIT * UNISWAP_BATCH_SIZE; i += UNISWAP_BATCH_SIZE) {
                const pairs = (yield uniswapQuery.functions.getPairsByIndexRange(factoryAddress, i, i + UNISWAP_BATCH_SIZE))[0];
    ...
    static getUniswapMarketsByToken(provider, factoryAddresses) {
        return __awaiter(this, void 0, void 0, function* () {
            const allPairs = yield Promise.all(_.map(factoryAddresses, factoryAddress => UniswappyV2EthPair.getUniswappyMarkets(provider, factoryAddress)));
            ...
            const allMarketPairs = _.chain(_.pickBy(marketsByTokenAll, a => a.length > 1) // weird TS bug, chain'd pickBy is Partial<>
                ...
                .flatten()
                .value();
            yield UniswappyV2EthPair.updateReserves(provider, allMarketPairs);
    ...
    static updateReserves(provider, allMarketPairs) {
        return __awaiter(this, void 0, void 0, function* () {
            const uniswapQuery = new ethers_1.Contract(addresses_1.UNISWAP_LOOKUP_CONTRACT_ADDRESS, abi_1.UNISWAP_QUERY_ABI, provider);
            ...
            const reserves = (yield uniswapQuery.functions.getReservesByPairs(pairAddresses))[0];
    ...
    sellTokensToNextMarket(tokenIn, amountIn, ethMarket) {
        return __awaiter(this, void 0, void 0, function* () {
            if (ethMarket.receiveDirectly(tokenIn) === true) {
                const exchangeCall = yield this.sellTokens(tokenIn, amountIn, ethMarket.marketAddress);
                return {
                    data: [exchangeCall],
    ...
    sellTokens(tokenIn, amountIn, recipient) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const populatedTransaction = yield UniswappyV2EthPair.uniswapInterface.populateTransaction.swap(amount0Out, amount1Out, recipient, []);
